...
import { X, DollarSign, FileText, Calendar, Upload, Paperclip } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <div className={`absolute top-3 ${isRTL ? 'right-0 pr-3' : 'left-0 pl-3'} pointer-events-none`}>
              ...
              <textarea
                ...
                rows={3}
                className={`block w-full ${isRTL ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm resize-none`}
                placeholder={getTranslation('enterDescription', language)}
                required
              />
            </div>
          </div>
