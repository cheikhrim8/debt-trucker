  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.amount) {
      const updates = {
        ...
        attachmentUrl: attachment ? URL.createObjectURL(attachment) : transaction.attachmentUrl,
        attachmentName: attachment?.name || transaction.attachmentName
      };
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">{transaction.personName}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
            >
          ...
          <div>
            ...
            <div className="relative">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">
                    {attachment ? attachment.name : 
                     transaction.attachmentName ? transaction.attachmentName : (
              ...
              {(attachment || transaction.attachmentName) && (
                <div className="mt-2 flex items-center text-sm text-gray-600">
                  <Paperclip className="w-4 h-4 mr-2" />
                  {attachment ? attachment.name : transaction.attachmentName}
                  <button
                    type="button"
